...
public class Word2VEC {
    ...
    public Word2VEC() {
        ...
        String path = root + "/src/main/resources/search_data/" + "Google_word2vec_zhwiki1710_300d.bin";

        double len = 0;
        float vector = 0;
        try (BufferedInputStream bis = new BufferedInputStream(new FileInputStream(path)); DataInputStream dis = new DataInputStream(bis)) {
            // //读取词数
