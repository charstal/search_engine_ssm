    ...
    <div id="page-wrapper" class="white-bg slimScrollDiv">
                    ...
                    <ul class="nav navbar-top-links navbar-left">
                        <li>
                                ...
                                var searchEvent = function () {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (res) {
                                            ...
                                            sessionStorage.setItem("hotpot", JSON.stringify(hotpotList));
                            ...
                            <script>
                                ...
                                function renderHotpot(res) {
                                    var page = "";
                                    for (var item in res) {
                                        page += "<div class=\"row\">";
                                        if(item == 0) {
                                            page += "<span class=\"label label-danger\">" + (Number(item) + 1) + "</span>";
                                        }
                                        else if (item == 1) {
                                            page += "<span class=\"label label-warning\">" + (Number(item) + 1) + "</span>";
                                        }
                                        else if (item == 2) {
                                            page += "<span class=\"label label-primary\">" + (Number(item) + 1) + "</span>";
                                        }
                                        else {
                                            page += "<span class=\"label label-info\">" + (Number(item) + 1) + "</span>";
                                        }
                                        page += "<a href=\"#\" class=\"hotpotKeyword\">";
                                        page += res[item];
                                        page += "</a>";
                                        page += "</div><br>"
                                    }

                                    var hotpotRank = document.getElementById("hotpotRank");
                                    hotpotRank.innerHTML = page;
                                }

                                function addHotpotListEvent() {
                                    var hotpotList = document.getElementsByClassName("hotpotKeyword");
                                    for(var i = 0; i < hotpotList.length; ++i) {
                                        hotpotList[i].onclick=function(event){
                                            console.log(this.text);
                                            $('#searchContext').val(this.text);
                                            searchEvent();
                                            event.preventDefault();
                                            // console.log(this.text)
                                        }
                                ...
                                function renderRecommend(res) {
                                    ...
                                    for (var item = 0; item < res.length; item = item + 3) {
                                        page += "<row>";

                                        for (var i = 0; i < 3; ++i) {
                                            if(item + i == res.length) {
                                                break;
                                            }
                                            page += "<div class=\"col-lg-4\">";
                                            page += "<a href=\"" + "${pageContext.request.contextPath}/note/" + res[(Number(item) + i)].docId + "\">";
                                            page += "<img class=\"img img-rounded\" style=\"width: 100px;height: 60px\" src=\"" + res[(Number(item) + i)].imageUrls[0] + "\">";
                                            page += "</a><br>";
                                            page += "<h5>" + "<a href=\"" + "${pageContext.request.contextPath}/note/" + res[(Number(item) + i)].docId + "\">" + res[(Number(item) + i)].title + "</a>" + "</h5>";
                                            page += "</div>";
                                        }
        ...
        <div class="wrapper wrapper-content ">
            ...
            <div class="container-fluid col-lg-4">
                <div class="ibox">
                    <h3>热点搜索</h3>
                    <div id="hotpotRank" class="col-md-offset-1">
                        <%--                        <div class="row">--%>
                ...
                <div class="ibox">
                    ...
                    <div id="recommend">
                        ...
                        <%--                            <div class="col-lg-4">--%>
                        <%--                                <a>--%>
                        <%--                                    <img class="img img-rounded" style="width: 100px;height: 60px"--%>
...
<script>
    ...
    $(function () {
        ...
        var hotpotList = JSON.parse(sessionStorage.getItem("hotpot"));
